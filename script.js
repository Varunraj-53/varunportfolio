...
window.addEventListener('scroll', () => {
    ...
    // Show/hide scroll to top button and add navbar shadow
...
document.querySelectorAll('section, .skill-card, .project-card, .stat-card, .contact-item').forEach(el => {
    el.style.opacity = '0';
...
const scrollReveal = () => {
    const reveals = document.querySelectorAll('.skill-card, .project-card, .about-text, .stat-card');
